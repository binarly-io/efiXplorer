...
/* all .text and .data segments for compatibility with the efiXloader */
...
vector<func_t *> efiAnalysis::efiAnalyzer::findSwSmiHandlers() {
    DEBUG_MSG("[%s] ========================================================\n",
              plugin_name);
    return findSmiHandlersSmmSwDispatch(dataSegments);
}
